...
const CACHE = 'medicar-socio-v43'; // Selector turnos excluye adulto-con-cuenta + doble campo password (canje) + olvidé mi contraseña. HTML network-first + purga de caches viejas
const SHELL = [
  './',
  './index.html',
  './manifest.json',
