...
const CACHE = 'medicar-socio-v37'; // DNI: checklist frente+dorso por integrante en "afiliación en proceso" + SDK storage. HTML network-first + purga de caches viejas
const SHELL = [
  './',
  './index.html',
  './manifest.json',
